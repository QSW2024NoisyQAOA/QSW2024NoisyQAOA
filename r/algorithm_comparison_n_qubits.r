...
WIDTH <- COLWIDTH
HEIGHT <- WIDTH * 0.55
do.save.pdf(g, "algorithm_comparison_n_qubits", WIDTH, HEIGHT)
do.save.tikz(g, "algorithm_comparison_n_qubits", WIDTH, HEIGHT)
